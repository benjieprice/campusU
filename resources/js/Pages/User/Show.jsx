...
import { STATUS_CLASS_MAP, STATUS_TEXT_MAP } from "@/constants.jsx";
          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="grid gap-1 grid-cols-2 mt-2">
                <div>
                  <div>
                    <label className="font-bold text-lg">ID Usuario</label>
                    <p className="mt-1">{user.id}</p>
                  </div>
                  <div className="mt-4">
                    <label className="font-bold text-lg">Nombre usuario</label>
                    <p className="mt-1">{user.name}</p>
                  </div>

                  <div className="mt-4">
                    <label className="font-bold text-lg">Estado Usuario</label>
                    <p className="mt-1">
                      <span
                        className={
              ...
              <div className="mt-4">
                <label className="font-bold text-lg">Descripcuón usuario</label>
